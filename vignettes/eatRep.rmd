...
```
## 'data.frame':	77322 obs. of  23 variables:
...
- `idstud`: individual student identifier; the data set contains 11637 persons overall 
- `idclass`: class identifier; the data set contains 433 classes overall 
- `wgt`: sampling weight
